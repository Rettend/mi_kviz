const questions = [
  ...
  },
  {
    ...
    "type": "pair",
    "pairs": [
      { "left": "hatalmas problématér", "right": "kombinatorikus robbanás" },
      { "left": "kínai szoba elmélet", "right": "MI szkeptikusok" },
      { "left": "útkeresési feladat", "right": "probléma modell" },
      { "left": "heurisztika", "right": "intuíció" }
    ]
  },
  {
    "id": 12,
  ...
  },
  {
    ...
    "options": [
      ...
      "Nem mert, ezt csak olyan feladatoknál használhatjuk, amelyek állapottérmodell-lel rendelkeznek. Ez tehát egy modell-függő stratégia.",
  ...
  },
  {
    ...
    "type": "pair",
    "pairs": [
      { "left": "Globális munkaterület", "right": "Irányított út" },
      { "left": "keresési szabály", "right": "visszalépés" },
      { "left": "másodlagos vezérlési stratégia", "right": "sorrendi szabály" },
      { "left": "Második változat", "right": "mélységi korlát figyelés" }
    ]
  },
  {
    "id": 38,
  ...
  },
  {
    ...
    "type": "pair",
    "pairs": [
      { "left": "mélységi gráfkeresés", "right": "nem-informált gráfkeresés" },
      { "left": "A* algoritmus", "right": "optimális megoldás" },
      { "left": "B algoritmus", "right": "Martelli" },
      { "left": "memória igény", "right": "zárt csúcsok száma" }
    ]
  },
  {
    "id": 73,
  ...
  },
  {
    ...
    "type": "pair",
    "pairs": [
      { "left": "kétpontos keresztezés", "right": "parciális illesztett keresztezés" },
      { "left": "kiválasztás", "right": "fittnesz függvény" },
      { "left": "egyed", "right": "kód" },
      { "left": "stratégiai paraméter", "right": "populáció mérete" }
    ]
  },
  {
    "id": 97,
  ...
  },
  {
    ...
    "type": "single",
    "options": [
      "A célállítás egy L_{1} ||...|| L_{n} egzisztenciálisan kvantált formula, ahol Li literál.",
  ...
  },
  {
    ...
    "type": "single",
    "options": [
      "A tényállás egy L_{1} ||...|| L_{n} egzisztenciálisan kvantált formula, ahol Li literál.",
      "A szabályok L->W alakúak, ahol W egy ÉS/VAGY formula, L egy literál és minden változó univerzálisan kvantált",
  ...
  },
  {
    ...
    "type": "multi",
    "options": [
      "Mindig azt a klózpárt rezolváljuk előbbb, amelyikben a literálok száma alegkevesebb.",
      ...
      "Soroljuk be szintekre a rezolúciós gráf klózait. Nulladik szinten a kiinduló klózok,az i+1-dik szinten azok, amelyek egyik szülője az i-dik szinten van, másik szülőjeaz első i szint valamelyikén. Állítsuk elő szintenként a klózokat."
    ],
    "correct": [
      1,
      2
  ...
  },
  {
    ...
    "options": [
      "Nem javítható",
      "A valószínűségi hálót példát generálására használjuk, amelyekből relatív gyakoriságot számolunk.",
  ...
  },
  {
    ...
    "type": "single",
    "options": [
      "Ha a minták inputjai közötti legnagyobb távolság  (valamilyen távolság metrika mellett) kisebb (ugyanazon metrika szerint).",
      "Ha mind azonos kimeneti értékkel rendelkezik.",
      "Ha a kimeneteik értékei mind különböznek.",
      "Ha a minták kimeneti értékei közötti legnagyobb távolság (valamilyen távolság metrika mellett) kisebb (ugyanazon metrika szerint)."
    ],
    "correct": [
      1
    ]
  },
  {
    ...
    "options": [
      ...
      "A csúcshoz tartozó attribútumok alapján, ha vannak ilyenek, különben véletlenszerűértéket kap."
    ],
    "correct": [
      2
    ]
